...
(function() {
  ...
  var contract_data = {
    ...
    contract_name: "ManagementFeeProtocol"
  };

  function Contract() {
    if (Contract.Pudding == null) {
      throw new Error("ManagementFeeProtocol error: Please call load() first before creating new instance of this contract.");
    }
  ...
  Contract.new = function() {
    if (Contract.Pudding == null) {
      throw new Error("ManagementFeeProtocol error: Please call load() first before calling new().");
    }
  ...
  Contract.at = function() {
    if (Contract.Pudding == null) {
      throw new Error("ManagementFeeProtocol error: Please call load() first before calling at().");
    }
  ...
  Contract.deployed = function() {
    if (Contract.Pudding == null) {
      throw new Error("ManagementFeeProtocol error: Please call load() first before calling deployed().");
    }
  ...
  if (typeof module != "undefined" && typeof module.exports != "undefined") {
    ...
    // and we can use that.
    window.ManagementFeeProtocol = Contract;
  }
