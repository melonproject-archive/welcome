...
contract FoundationToken is owned, TokenProtocol {
    ...
    function FoundationToken(uint256 initialSupply, string tokenName, uint8 decimalUnits, string tokenSymbol, address centralMinter) {
